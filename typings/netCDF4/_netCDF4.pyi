...
class Dataset:
    ...
    def createVariable(
        ...
        contiguous: bool = ...,
        chunksizes=...,
        szip_coding: Literal["nn", "ec"] = ...,
        szip_pixels_per_block: Literal[4, 8, 16, 32] = ...,
        blosc_shuffle: Literal[0, 1, 2] = ...,
        endian: Literal["big", "little", "native"] = ...,
        least_significant_digit: int | None = ...,
        significant_digits: int | None = ...,
        quantize_mode: Literal["BitGroom", "BitRound", "GranularBitRound"] = ...,
        fill_value=...,
        chunk_cache=...,
    ) -> Variable: ...
    def delncattr(self, name: str, value) -> None: ...
    def filepath(self, encoding: Literal["utf-8"] | str = ...) -> str: ...
    def fromcdl(self, cdlfilename, ncfilename=..., mode=..., format=...) -> Any: ...
    @overload
    def get_variables_by_attributes(self, axis: str = ...) -> Any: ...
    @overload
    def get_variables_by_attributes(self, standard_name: str = ...) -> Any: ...
    @overload
    ...
    def set_always_mask(self, True_or_False: bool) -> Any: ...
...
class Variable:
    ...
    always_mask: bool
    chartostring: bool
    datatype: VLType | CompoundType | DTypeLike
    dimensions: tuple[str, ...]
    dtype: DTypeLike
    mask: bool
    name: str
    ...
    def set_collective(self, True_or_False: bool) -> None: ...
    def set_ncstring_attrs(
        self, *args, **kwargs
    ) -> (
        None
    ): ...  # https://unidata.github.io/netcdf4-python/#Variable.set_ncstring_attrs
    ...
    # def __getattr__(self, name) -> Any: ...
    def __getitem__(self, index) -> NDArray | MaskedArray | Any: ...
    # def __len__(self) -> Any: ...
    # def __reduce__(self) -> Any: ...
    # def __setattr__(self, name, value) -> Any: ...
...
def chartostring(b: str, encoding=...) -> str: ...
